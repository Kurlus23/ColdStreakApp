        ...
        <div className="space-y-8 text-sm leading-relaxed">
          ...
          <section>
            ...
            <ul className="list-disc list-inside text-slate-600 space-y-1.5 mb-3 text-sm">
              <li><span className="font-semibold text-slate-700">ColdStreak Pro — Lifetime ($19.99 one-time):</span> A single non-recurring purchase that permanently unlocks Pro features on your account. All sales are final and non-refundable except where required by applicable law or the policies of the platform through which you purchased (Apple App Store or Google Play).</li>
