        ...
        <div className="space-y-8 text-sm leading-relaxed">
          ...
          <section>
            ...
            <ul className="list-disc list-inside text-slate-600 space-y-1.5 mb-3 text-sm">
              ...
              <li><span className="font-semibold text-slate-700">Verified Business Listing — tiered subscriptions (first month free):</span> A recurring monthly subscription for businesses seeking verified listings in the ColdStreak Explore tab. Available tiers: <strong>1 location at $29.99/month</strong>, <strong>up to 3 locations at $79.99/month</strong>, and <strong>up to 10 locations at $129.99/month</strong>. Businesses with more than 10 locations may contact us at <a href="mailto:ColdStreakApp17@gmail.com" className="text-cyan-600 hover:underline">ColdStreakApp17@gmail.com</a> for enterprise pricing. The first calendar month is provided at no charge; subsequent months are billed automatically. You may cancel at any time; access continues until the end of the paid period. Refunds for business listing subscriptions are not provided except as required by law.</li>
            </ul>
            <p className="text-slate-600">
