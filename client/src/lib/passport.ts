...
export type Difficulty = "beginner" | "cold" | "very-cold" | "ice-water" | "legendary";
...
export const DIFFICULTY_META: Record<Difficulty, { emoji: string; label: string; color: string }> = {
  beginner:    { emoji: "🟢", label: "Beginner",  color: "text-green-400" },
  cold:        { emoji: "🟡", label: "Cold",       color: "text-yellow-400" },
  "very-cold": { emoji: "🔵", label: "Very Cold",  color: "text-blue-400" },
  "ice-water": { emoji: "🔴", label: "Ice Water",  color: "text-red-400" },
  legendary:   { emoji: "⚫", label: "Legendary",  color: "text-purple-400" },
};
