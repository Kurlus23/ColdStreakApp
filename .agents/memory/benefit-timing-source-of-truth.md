---
name: Benefit timing source of truth
description: Keeps coach duration guidance aligned with the personalized Benefit Bar thresholds.
---

## Rule
The personalized Benefit Bar threshold is the authoritative exact target for Energy, Mood, Metabolism, and Recovery. Coach responses may suggest longer progression sessions, but must not present a generic duration as the user's exact benefit goal.
