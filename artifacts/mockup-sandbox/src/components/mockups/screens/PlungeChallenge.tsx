// Active plunge overlay — challenge mode (4-column stats row)
...
export function PlungeChallenge() {
  return (
    <div className="w-[390px] h-[844px] relative overflow-hidden font-sans select-none flex flex-col items-center justify-between bg-[#0c1a2e]">
      ...
      {/* Subtle red rivalry tint */}
      <div className="absolute inset-0 bg-[radial-gradient(circle_at_100%_50%,rgba(251,113,133,0.06),transparent_60%)] pointer-events-none" />
      ...
      <div className="w-full flex flex-col items-center gap-5 pb-10 z-10 px-6">
        {/* Stats row — 4 columns when challenged */}
        <div className="flex items-center justify-between w-full px-1">
          ...
          <div className="flex flex-col items-center">
            <span className="text-cyan-400 text-[9px] uppercase tracking-widest mb-1 font-semibold">Cold Score</span>
          ...
          <div className="flex flex-col items-center relative">
            <span className="text-rose-400 text-[9px] uppercase tracking-widest mb-1 font-semibold">vs Jake</span>
            <span className="text-rose-300 text-2xl font-bold tracking-tight"
              style={{ textShadow: "0 0 12px rgba(251,113,133,0.5)" }}>8.4</span>
            {/* Dismiss */}
            <button className="absolute -top-2 -right-3 text-slate-600 text-[9px] leading-none">✕</button>
          </div>

          <div className="w-px h-10 bg-gradient-to-b from-transparent via-slate-700 to-transparent" />

          <div className="flex flex-col items-center">
            <span className="text-amber-400 text-[9px] uppercase tracking-widest mb-1 font-semibold">Personal Best</span>
