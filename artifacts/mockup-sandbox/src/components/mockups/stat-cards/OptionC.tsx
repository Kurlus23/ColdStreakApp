export function OptionC() {
  const btConnected = true; // toggle to see both states
      ...
      <div className="w-full max-w-sm rounded-2xl px-2 py-3"
        ...
        <div className="grid grid-cols-3">
          ...
          <div className="flex flex-col items-center px-2 py-2 relative">
            ...
            {/* Always in DOM — invisible when not connected so height is always reserved */}
            <div className="flex items-center gap-1 mt-2" style={{ visibility: btConnected ? "visible" : "hidden" }}>
